...
public class MyDBInfo {
	...
	public static final String MYSQL_USERNAME = "ccs108balansay";
	public static final String MYSQL_PASSWORD = "ohyaecoo";
	public static final String MYSQL_DATABASE_SERVER = "mysql-user-master.stanford.edu";
	public static final String MYSQL_DATABASE_NAME = "c_cs108_balansay";
